...
import styles from "./CookieSec.module.scss"
const CookieSec = () => {
    window.scrollTo(0, 0);
  return (
    ...
    <div className={styles.container}>
        ...
        <p>Effective Date/Last Updated: June 14th, 2023</p>
        <p>Unless otherwise expressly stated, capitalized terms in this Notice have the same meaning as defined in the  Privacy Policy.

            For California, Colorado, Connecticut, Utah, and Virginia Residents: To exercise your right to opt-out of the sale of sharing of personal data as it relates to the use of cookies and other tracking technologies for analytics and targeted advertising and cross-context behavioral advertising, please see the “Your Privacy Rights” section of the U.S. Privacy Disclosures in our Privacy Policy or click here to adjust your cookie settings.</p>
        </div>
        <div className={styles.text}>
            <h3>Scope of Notice</h3>
        <p>This Cookie Policy supplements the information contained in the Privacy Policy by explaining how we and our business partners and services providers use cookies and related technologies in the course of managing and providing our online services and our communications to you. It explains what these technologies are and why we use them, as well as your rights to control our use of them.

            In some cases, we may use cookies and related technologies described in this Cookie Policy to collect personal data, or to collect information that becomes personal data if we combine it with other information. For more details about how we process your personal data, please review the  Privacy Policy.</p></div>
       <div className={styles.text}>
        <h3>What Are Cookies and Related Technologies</h3>
        <p>Cookies are small data files that are stored on your computer that allow us and our third-party partners and providers to collect certain information about your interactions with our email communications, websites and other online services.  We and our third-party partners and providers may also use other, related technologies to collect this information, such as web beacons, pixels, embedded scripts, location-identifying technologies and logging technologies (collectively, “cookies”).</p>
       </div>

       <div className={styles.text}>
        <h3>What We Collect When Using Cookies</h3>
        <p>We and our third-party partners and providers may use cookies to automatically collect certain types of usage information about how you access and use the services when you visit or interact with our email communications or websites or otherwise engage with us through a computer or mobile device. For example, we may collect log data about your device and its software, such as your IP address, operating system, browser type, date/time of your visit, and other similar information. We may collect analytics data or use third-party analytics tools such as Google Analytics to help us measure usage and activity trends for our online services and better understand our customer base.
       ...
       <div className={styles.text}>
        <h3>Third Party Data Collection & Interest-Based Advertising</h3>
        ...
        <p>Facebook. To learn more about your advertising preferences on Facebook Companies, click here
        ...
        <p>If you would prefer not to accept cookies, most browsers will allow you to: (i) change your browser settings to notify you when you receive a cookie, which lets you choose whether or not to accept it; (ii) disable existing cookies; or (iii) set your browser to automatically reject cookies. Please note that doing so may negatively impact your experience using our online services, as some features and services on our online services may not work properly. In addition, if you want to reject cookies across all your browsers and devices, you will need to do so on each browser on each device you actively use. Depending on your device and operating system, you may not be able to delete or block all cookies. You may also set your email options to prevent the automatic downloading of images that may contain technologies that would allow us to know whether you have accessed our email and performed certain functions with it.
            ...
            You can learn more about Google’s practices with Google Analytics by visiting Google’s privacy policy here. You can also view Google’s currently available opt-out options here.</p>
        </div>
        <div className={styles.text}>
        <h3>Your Choices About Online Ads</h3>
        <p>Controlling Cookies and Tracking Technologies. To control your cookie preferences through our cookie management tool on the website, including to opt out of targeted advertising, please click here.

            Most browsers also allow you to adjust your browser settings to: (i) notify you when you receive a cookie, which lets you choose whether or not to accept it; (ii) disable existing cookies; or (iii) set your browser to automatically reject cookies. Blocking or deleting cookies may negatively impact your experience using the Service, as some features and services may not work properly. Depending on your device and operating system, you may not be able to delete or block all tracking technologies.
            ...
            Please note that deleting or blocking cookies may not be effective for all types of tracking technologies, such as Local Storage Objects (LSOs) like HTML5.</p>
        </div>
        <div className={styles.text}>
        <h3>Updates to This Cookie Policy</h3>
        <p>We will update this Cookie Policy from time to time. When we make changes to this Cookie Policy, we will change the "Last Updated" date at the beginning of this Notice. If we make material changes to this Notice, we will notify you by email to your registered email address, by prominent posting on this website or our online services, or through other appropriate communication channels. All changes shall be effective from the date of publication unless otherwise provided in the notification.</p>
        </div>
        <div className={styles.text}>
        <h3>Contact Us</h3>
        <p>If you have any questions or requests in connection with this Cookie Policy or other privacy-related matters, please send an email to  usprivacy@pandora.net.
